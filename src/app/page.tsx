    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
        <div className="text-center p-6">
          <div className="flex justify-center mb-3"><Brain className="w-12 h-12 text-primary" /></div>
        ...
        <div className="text-center p-6">
          <div className="flex justify-center mb-3"><Smartphone className="w-12 h-12 text-secondary" /></div>
        ...
        <div className="text-center p-6">
          <div className="flex justify-center mb-3"><BarChart3 className="w-12 h-12 text-primary" /></div>
