			...
			<CardHeader className="pb-3">
				...
				<div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
					...
					<div className="flex items-center gap-2">
						<Link href={`/decks/${deck.id}`} className={cn(buttonVariants({ variant: "outline", size: "sm" }), "h-8 px-3")}>
			...
			{completion && completion.total > 0 && (
				<CardContent className="pt-0 flex justify-center sm:justify-start">
					<Link
						...
						className={cn(buttonVariants({ variant: "secondary" }), "w-full sm:w-auto group")}
					>
